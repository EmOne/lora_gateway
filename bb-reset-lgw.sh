...
#       - export/unpexort GPIO49 used to reset the SX1301 chip
#
# Usage examples:
#       ./bb_reset_lgw.sh stop
#       ./bb_reset_lgw.sh start

# The reset pin of SX1301 is wired with Beagle Bone Black GPIO49
# If used on another platform, the GPIO number can be given as parameter.
if [ -z "$2" ]; then 
    IOT_SK_SX1301_RESET_PIN=49
else
